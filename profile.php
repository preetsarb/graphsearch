                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                               ...
                               <div class="col-lg-6">
                                   ...
                                   $userd = $_SESSION['user'];
                                   $usert = $_POST['user'];
                                   $query = 'match (:Person {username:'."\"$userd\"".'})-[r:FRIEND_OF]-(:Person {name:'."\"$usert\"".'}) return r';

                                   try{
                                    $resultt = $neo4j->statement($query);
        //echo "hi";
                                }
                                catch (EndyJasmi\Neo4j\Error\Neo\ClientError\Statement\InvalidSyntax $e) {
    // Caught here!
...
//echo $result;
                                if(!(count($resultt) > 0)){
                                   ...
                                   <h3><form action="./friends.php" method="POST">
                                     <input type="text" hidden name="name" id="name" value="<?php echo $_POST['user']; ?>">
                                     <input type="text" hidden name="action" value="add">
                                     <button class="btn btn-default">Add Friend <i class="fa fa-plus"></i></button> 
                                 </form>
                          <?php   }
                             else{
                                ?>
                               ...
                               <h3><form action="./friends.php" method="POST">
                                 ...
                                 <button class="btn btn-danger">Remove Friend <i class="fa fa-minus"></i></button> 
                             </form>
                        <?php }
