                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">                                
                                <div class="row-fluid user-row">
                                    <img src="logo_sm_2_mr_1.png" class="img-responsive" alt="Conxole Admin"/>
                                </div>
                            </div>
                            <div class="panel-body">
                                <form action="process.php" method="POST" accept-charset="UTF-8" role="form" class="form-signin">
                                    <fieldset>
                                        ...
                                        <br></br>
                                        <input type="text" hidden id="action"  name="action" value="signup">
